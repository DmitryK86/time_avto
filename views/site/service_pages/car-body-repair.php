...
<div class="main-content">
    ...
    <p>Цены на кузовной ремонт и покраску автомобиля в нашем СТО одни из самых демократичных в Санкт-Петербурге.</p>

    <table class="table table-bordered table-striped">
        <tbody>
        <tr>
            <th colspan="3">Работа с одним элементом</th>
        </tr>
        <tr>
        ...
        <tr>
            <td>Стойки/Внутренние элементы</td>
            <td>(х 0,5)</td>
            <td>2 750</td>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="3">Работа со всем кузовом</th>
        </tr>
        <tr>
            <td colspan="2">Металлик / перламутр</td>
            <td>от 80 000</td>
        </tr>
        <tr>
            <td colspan="2">Матовый / матовый софт тач</td>
            <td>от 90 000</td>
        </tr>
        <tr>
            <td colspan="2">Хамелеон / мультицвет</td>
            <td>от 100 000</td>
        </tr>
        <tr>
            <th colspan="3">Примеры расчета</th>
        </tr>
        <tr>
            <td colspan="2">Капот + переднее крыло + бампер передний</td>
            <td>19 250</td>
        </tr>
        <tr>
            <td colspan="2">Заднее крыло + задний бампер</td>
            <td>11 000</td>
        </tr>
        <tr>
            <td colspan="2">Капот + крыло + бампер + передняя панель</td>
            <td>30 000</td>
        </tr>
        <tr>
            <td colspan="2">Задний бампер + крыло + задняя панель</td>
            <td>16 500</td>
        </tr>
        </tbody>
    </table>
    ...
    <p>Автосервис Форсаж предлагает следующие виды ремонта и покраски автомобиля:</p>
